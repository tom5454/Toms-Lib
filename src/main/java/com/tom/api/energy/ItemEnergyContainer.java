...
public class ItemEnergyContainer extends Item implements IEnergyContainerItem {
	...
	public ItemEnergyContainer(long capacity) {
		this(capacity, capacity, capacity);
	}

	public ItemEnergyContainer(long capacity, double maxTransfer) {
		this(capacity, maxTransfer, maxTransfer);
	}

	public ItemEnergyContainer(long capacity, double maxReceive, double maxExtract) {
	...
	public static String getInfo(IEnergyContainerItem item, ItemStack stack) {
		...
		long max = item.getMaxEnergyStored(stack);
