...
public class EnergyStorage implements IEnergyStorage {
	...
	public EnergyStorage(long capacity, double maxTransfer) {
		this(capacity, maxTransfer, maxTransfer);
	}

	public EnergyStorage(long capacity, double maxReceive, double maxExtract) {
		this.capacity = capacity;
	...
	public IEnergyStorageHandlerCapability toCapability(boolean canInsert, boolean canExtract, EnergyType type) {
		return new EnergyStorageWrapper(this, canInsert, canExtract, type);
	}

	private static class EnergyStorageWrapper implements IEnergyStorageHandlerCapability {
