...
public enum EnergyType implements IStringSerializable {
	...
	public static IEnergyStorageHandlerCapability getHandlerFrom(World world, BlockPos pos, EnumFacing side) {
	...
	public static IEnergyStorageHandlerCapability getHandlerFrom(World world, BlockPos pos, EnumFacing side, Predicate<TileEntity> checkIfValid) {
		TileEntity rec = world.getTileEntity(pos.offset(side.getOpposite()));
	...
	public double pushEnergyTo(IEnergyStorageHandlerCapability h, double energyStored, double maxPush, boolean simulate) {
		if (h != null) {
	...
	public double pushEnergyTo(IEnergyStorageHandlerCapability h, IEnergyStorage energy, boolean simulate) {
	...
	public double pushEnergyTo(IEnergyStorageHandlerCapability h, IEnergyStorage energy, double max, boolean simulate) {
	...
	public static void init() {
		FORCE.multiplier = HV.multiplier * LibInit.forceMultipier;
		CapabilityManager.INSTANCE.register(IEnergyStorageHandlerCapability.class, new IStorage<IEnergyStorageHandlerCapability>() {

			@Override
			public NBTBase writeNBT(Capability<IEnergyStorageHandlerCapability> capability, IEnergyStorageHandlerCapability instance, EnumFacing side) {
				return null;
			}

			@Override
			public void readNBT(Capability<IEnergyStorageHandlerCapability> capability, IEnergyStorageHandlerCapability instance, EnumFacing side, NBTBase nbt) {

			}

		}, new Callable<IEnergyStorageHandlerCapability>() {

			@Override
			public IEnergyStorageHandlerCapability call() throws Exception {
				return new EnergyHandlerNormal(EnumFacing.DOWN);
			}
		});
	}

	@CapabilityInject(IEnergyStorageHandlerCapability.class)
	public static Capability<IEnergyStorageHandlerCapability> ENERGY_HANDLER_CAPABILITY = null;

	public static class EnergyHandlerNormal implements IEnergyStorageHandlerCapability {
		IEnergyHandler h;
		EnumFacing from;
	...
	public static class EnergyHandlerProvider implements IEnergyStorageHandlerCapability {
		IEnergyProvider h;
		EnumFacing from;
	...
	public static class EnergyHandlerReceiver implements IEnergyStorageHandlerCapability {
		IEnergyReceiver h;
		EnumFacing from;
